...
namespace Splid.WebAPI.Controllers
{
    public class ExpensesController : Controller
    {
        ...
        public async Task<IActionResult> CreateExpense(Guid groupId, [FromBody]CreateExpenseDto createExpenseDto)
        {
            ...
            var createExpenseCommand = new CreateExpenseCommand() { GroupId = groupId, ExpenseId = expenseId, Expense = expenseInput };
        ...
        public async Task<IActionResult> ChangeExpense(Guid groupId, Guid expenseId, [FromBody]ChangeExpenseDto changeExpenseDto)
        {
            var expenseInput = _mapper.Map<ExpenseInput>(changeExpenseDto);
            var changeExpenseCommand = new ChangeExpenseCommand() { GroupId = groupId, ExpenseId = expenseId, Expense = expenseInput };
